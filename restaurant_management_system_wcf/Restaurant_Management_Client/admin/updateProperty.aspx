<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateProperty.aspx.cs" MasterPageFile="~/masters/admin.Master" Inherits="Restaurant_Management_Client.admin.updateProperty" %>

<asp:Content runat="server" ContentPlaceHolderID="titleSection">Update Property</asp:Content>
<asp:Content ContentPlaceHolderID="contantSection" runat="server">
    <div style="text-align:center;padding-top:15px;">
        <h2 class="login100-form-title">Update Property</h2>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox6" ErrorMessage="Owner required"></asp:RequiredFieldValidator>
                ...
                <div class="container-login100-form-btn">
                    <asp:Button ID="Button2" CssClass="login100-form-btn" runat="server" OnClick="Button2_Click" Text="Update" />
                </div>
                <div>
                </div>
            </div>
