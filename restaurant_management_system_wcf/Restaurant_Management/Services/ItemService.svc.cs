...
namespace Restaurant_Management.Services
{
    ...
    {
        //private readonly string path_ = @"C:\Users\Dhruv j Patel\Desktop\wcf\restaurant_management_system_wcf\Restaurant_Management_Client\static\images";
        ...
        //    try
        //    {
        //        imagePath = String.Format(@"{0}\{1}", path_, fileName);
        ...
        //        filePath = String.Format(@"{0}\{1}", path_, fileName);
